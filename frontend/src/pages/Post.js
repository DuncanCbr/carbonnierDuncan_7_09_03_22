...
<CloseIcon aria-hidden="false" className="closeModal" onClick={()=> {document.getElementById("modal").style.display = "none";}}/>
...
<EditIcon aria-hidden="false" className="delModBtn pointer" onClick={()=> {
...
<img src={`http://localhost:3002/${postObject.image}`} alt="image ajout̩ par un utilisateur" className="imgPost" />
</div>
)}
...
<button className="dltBtn pointer" onClick={()=> {
...
<label className="commentLabelDisplay"><span className="commentLabel">Votre commentaire</span>
<input className="inputComment" value={newComment} type="text" placeholder="commentaire..." onChange={(event)=> {
